...
export const motivationOptions: Array<{ value: string; label: string }> = [
	{
		value: 'Connect with a global community',
		label: 'Connect with a global community',
	},
	{ value: 'Leadership Experience', label: 'Leadership Experience' },
	{ value: 'Develop yourself', label: 'Develop yourself' },
	{ value: 'Create Positive Impact', label: 'Create Positive Impact' },
];
